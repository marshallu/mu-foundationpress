...
register_nav_menus(array(
	'top-bar-l' => 'Primary Navigation', // Registers the menu in the WordPress admin menu editor.
	'mobile-off-canvas' => 'Mobile Navigation',
    'recognition_menu' => 'Recognition Menu',
    'about_menu' => 'About Menu',
    'contact_menu' => 'Contact Us Menu',
    'givetoday_menu' => 'Give Today Menu',
    'givingprograms_menu' => 'Giving Programs Menu',
    'faq_menu' => 'FAQ Menu',
));
...
if ( ! function_exists( 'foundationpress_foundation_menu' ) ) {
    function foundationpress_foundation_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'top-bar-menu foundation-menu',           // Adding custom nav class
            'theme_location' => 'foundation-menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
...
if ( ! function_exists( 'foundationpress_recognition_menu' ) ) {
    function foundationpress_recognition_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'recognition_menu',           // Adding custom nav class
            'theme_location' => 'recognition_menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
...
if ( ! function_exists( 'foundationpress_about_menu' ) ) {
    function foundationpress_about_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'about_menu',           // Adding custom nav class
            'theme_location' => 'about_menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
...
if ( ! function_exists( 'foundationpress_contact_menu' ) ) {
    function foundationpress_contact_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'about_menu',           // Adding custom nav class
            'theme_location' => 'contact_menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
...
if ( ! function_exists( 'foundationpress_givetoday_menu' ) ) {
    function foundationpress_givetoday_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'about_menu',           // Adding custom nav class
            'theme_location' => 'givetoday_menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
...
/**
 * Giving Programs Menu
 */

if ( ! function_exists( 'foundationpress_givingprograms_menu' ) ) {
    function foundationpress_givingprograms_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'about_menu',           // Adding custom nav class
            'theme_location' => 'givingprograms_menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
...
if ( ! function_exists( 'foundationpress_faq_menu' ) ) {
    function foundationpress_faq_menu() {
        wp_nav_menu(array(
            'container' => false,                           // Remove nav container
            'container_class' => '',                        // Class of container
            'menu' => '',                                   // Menu name
            'menu_class' => 'about_menu',           // Adding custom nav class
            'theme_location' => 'faq_menu',                // Where it's located in the theme
            'before' => '',                                 // Before each link <a>
            'after' => '',                                  // After each link </a>
            'link_before' => '',                            // Before each link text
            'link_after' => '',                             // After each link text
