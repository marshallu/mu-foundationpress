...
function osc_add_efs_plugin($plugin_array) {
    global $efselements;
    foreach ($efselements as $element) {
        $plugin_array['oscitasefs' . $element] = get_stylesheet_directory_uri() . '/easy-foundation-shortcodes/shortcode/' . $element . '/' . $element . '_plugin.js';
    }
    $version=floatval(get_bloginfo('version'));
    if($version<3.9){
        $plugin_array['oscitas_efs_main_dropdown']= get_stylesheet_directory_uri() . '/easy-foundation-shortcodes/js/oscitas_main_dropdown.js';
    } else{
        $plugin_array['oscitas_efs_main_dropdown']= get_stylesheet_directory_uri() . '/easy-foundation-shortcodes/js/oscitas_dropdown_3_9.js';
    }
    return $plugin_array;
}